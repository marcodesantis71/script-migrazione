...
echo "ssh-rsa  thegod@master" > /home/thegod/.ssh/id_rsa.pub

echo "ssh-rsa  thegod@thegod-mbp-wifi.sistemiesistemi.it" > /home/thegod/.ssh/authorized_keys
}
...
alias CASINA_LOG='tail -100f /var/log/homebridge/homebridge_casina.log'
alias LGTV_LOG='tail -100f /var/log/homebridge/homebridge_lgtv.log'
alias HARMONY_LOG='tail -100f /var/log/homebridge/homebridge_harmony.log'
alias SECURITY_LOG='tail -100f /var/log/homebridge/homebridge_security.log'
alias ZWAVE_LOG='tail -100f /var/log/homebridge/homebridge_zwave.log'
...
alias HOMEBRIDGE_ZWAVE_START='sudo systemctl start homebridge_zwave'
alias HOMEBRIDGE_ZWAVE_RESTART='sudo systemctl restart homebridge_zwave'
alias HOMEBRIDGE_ZWAVE_STOP='sudo systemctl stop homebridge_zwave'
...
echo \"ZWAVE_LOG: tail sul homebridge_zwave\"
...
echo "HOMEBRIDGE_ZWAVE_START"
echo "HOMEBRIDGE_ZWAVE_RESTART"
echo "HOMEBRIDGE_ZWAVE_STOP"
echo \"=====================================\"
echo \"\"
